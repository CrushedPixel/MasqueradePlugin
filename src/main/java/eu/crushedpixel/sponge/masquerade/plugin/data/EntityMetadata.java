...
public abstract class EntityMetadata<T, U> {
     ...
     */
    protected boolean valueChangeAllowed = true;
    ...
    public DataEntry<T> handleOutgoingDataEntry(DataEntry<T> dataEntry) {
        ...
        if (!valueChangeAllowed) return null;
    ...
    public void setValueChangeAllowed(boolean allowValueChange) {
        this.valueChangeAllowed = allowValueChange;
    }
