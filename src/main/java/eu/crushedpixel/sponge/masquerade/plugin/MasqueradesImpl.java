...
import eu.crushedpixel.sponge.masquerade.plugin.masquerades.AgeableMasquerade;
import eu.crushedpixel.sponge.masquerade.plugin.masquerades.CreeperMasquerade;
import eu.crushedpixel.sponge.masquerade.plugin.masquerades.FallingBlockMasquerade;
import eu.crushedpixel.sponge.masquerade.plugin.masquerades.LivingMobMasquerade;
import eu.crushedpixel.sponge.masquerade.plugin.masquerades.MinecartMasquerade;
import eu.crushedpixel.sponge.masquerade.plugin.masquerades.ObjectMasquerade;
import eu.crushedpixel.sponge.masquerade.plugin.masquerades.TameableMobMasquerade;
import eu.crushedpixel.sponge.masquerade.plugin.masquerades.WolfMasquerade;
...
public class MasqueradesImpl implements Masquerades {

    private final Map<EntityType, Function<Player, Masquerade>> REGISTRY = new HashMap<>();
    ...
    @Override
    public void registerDefault(EntityType entityType, Function<Player, Masquerade> function) {
        REGISTRY.put(entityType, function);
    }

    @Override
    public Masquerade fromType(EntityType entityType, Player player) {
    ...
    @Override
    public Masquerade fallingBlock(BlockState blockState, Player player) {
