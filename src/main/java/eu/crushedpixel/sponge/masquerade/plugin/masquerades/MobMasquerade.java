...
import eu.crushedpixel.sponge.masquerade.plugin.data.InvertedBooleanMetadata;
import eu.crushedpixel.sponge.masquerade.plugin.data.flag.BooleanFlagEntityMetadata;
